  ...
  <div>
    ...
    <div class="mt-16 w-10/12 mx-auto">
      ...
      <form
        ...
        class="mt-4 bg-gray-300 w-64 p-4"
        v-if="showForm"
      >
      ...
      <form
        @submit.prevent="doEditUser"
        class="mt-4 bg-gray-300 w-5/12 p-4"
        v-if="editForm"
      >
        <div class="flex flex-col">
          <h2 class="py-2">
      ...
      <table class="table-auto mt-4">
        ...
        <tbody>
          ...
          >
            ...
            <td class="table-col">
              <button @click="setEdit(user.id)" class="btn bg-orange-400">
                Edit
              </button>
              <button @click="deleteUser(user.id)" class="btn bg-red-400 ml-4">
                Delete
              </button>
            </td>
          </tr>
